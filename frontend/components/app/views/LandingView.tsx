    ...
    <div className="min-h-screen flex flex-col relative overflow-hidden bg-aurora-bg text-aurora-text">
      ...
      <nav className="relative z-10 w-[80%] mx-auto px-6 py-3 flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <span className="font-mono text-lg tracking-[0.28em] font-bold text-aurora-text">{appName}</span>
        </div>
      ...
      <footer className="w-full border-t border-aurora-border mt-20 py-6 text-center text-aurora-text text-sm font-mono">
        <p>© 2024 Crossflow. Borderless payments built on Tempo Testnet with Stripe integration.</p>
      </footer>
    </div>
  );
};
