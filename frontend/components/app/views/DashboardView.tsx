  ...
  onOpenBankModal,
    ...
    return (
      <div className="min-h-screen bg-aurora-bg pb-10">
          ...
          <div className="w-[80%] mx-auto px-6 py-3 flex justify-between items-center">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative group">
                <div
                  className="w-10 h-10 rounded-full border-2 border-aurora-primary/20 shadow-neon-strong transition-transform group-hover:scale-105 bg-aurora-bg overflow-hidden"
                  dangerouslySetInnerHTML={{
                    __html: jdenticon.toSvg(address || '0x0000000000000000000000000000000000000000', 40),
                  }}
                />
        ...
        <main className="w-full md:w-[90%] xl:w-[80%] mx-auto px-4 md:px-6 py-6 md:py-10 space-y-6 md:space-y-10">
          <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <div className="p-6 flex flex-col justify-between flex-1 relative">
                ...
                <div className="flex flex-col md:grid md:grid-cols-[35%_65%] flex-1">
                  <div className="border-b md:border-b-0 md:border-r border-aurora-border pb-6 md:pb-0 md:pr-6">
                    ...
                    {address && (
                      <div className="mb-6">
                        <div className="flex flex-wrap items-center gap-2 mb-2">
                          ...
                          <span className="text-base font-mono text-aurora-primary break-all">
                            {shortenedAddress}
                          </span>
                          <button
                            type="button"
          ...
          <section>
            <div className="flex md:items-center justify-between mb-6 flex-col md:flex-row gap-4 md:gap-0">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                    <button
                      ...
                      className={`w-7 h-7 text-xs font-mono rounded border transition-colors ${currentPage === page
            ...
            {transactions.length === 0 ? (
              ...
              <div className="glass-panel rounded-sm overflow-hidden overflow-x-auto">
                  ...
                  <tbody>
                    {paginatedTransactions.map((tx) => (
                      <tr key={tx.id} className="border-b border-aurora-border last:border-b-0 hover:bg-aurora-primary/5 transition-colors">
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-2">
                            <div className={`w-6 h-6 rounded-full flex items-center justify-center border ${tx.type === 'receive' || tx.type === 'deposit'
                        ...
                        <td className="px-4 py-3">
                          <span className={`px-2 py-1 text-xs font-mono rounded ${tx.status === 'completed' || tx.status === 'success' ? 'bg-green-500/10 text-green-500' :
                        ...
                        <td className="px-4 py-3 text-right">
                          <span className={`font-mono text-sm ${tx.type === 'receive' || tx.type === 'deposit' ? 'text-green-500' : 'text-aurora-text'
                            }`}>
